# 小咪 Meemate · 最合你拍的AI生活搭子

iMessage 式的多 agent 生活伴侣。几个有人格的 AI 朋友记着你的口味和节奏，在你需要做生活决策的那一刻先开口，并把决策落成一次下单、一次导航、一段行程。

你一定也有过这种时刻：加完班站在街头，又累又饿，却连选哪家店都懒得动脑；或者好不容易到了周末，想出去透透气，却被翻不完的攻略折腾得没了兴致。 本该放松的闲暇，却被卡在了繁琐的“做功课”里... 

我们不想做那个等你下指令的“冰冷工具”，我们更想做那真正懂你的老友——在你疲惫的时候，默默为你点好最喜欢的那杯低糖拿铁；在你犹豫不决时，主动对你说句：“走，车到了，带你去吃那家你念叨很久的烤肉。”

Meemate的出现，就是为了把“做决定”这件事本身，重新变回一种生活的乐趣。 

不被攻略绑架，不为选择疲惫。 有 Meemate在，出发永远纯粹尽兴。


产品方案见上一级目录的 `iMessage式AI朋友-产品设计方案.md`。

## 产品理念：入口从 app 变成 agent 之后

app 时代，每个 app 都是一座孤岛：点外卖一个 app，订票另一个，攻略又是一个。它们互不相识，你的偏好、你的日程、你刚说过的话，全被分别锁在各自的数据库里，只有你自己在中间来回搬运、反复交代。

Meemate 想验证反过来的答案：agent 不是孤岛，是一群共享同一份记忆、真会商量的朋友。首页不是一堆互不相干的图标，是一份朋友列表——他们各管一摊，却看着关于你的同一份记忆，遇到事会互相打招呼，一起帮你拿主意。

这版里已经能看到雏形：

- **一份记忆，所有 agent 共用。** 你跟小咪说过不吃香菜，吃什么群、周末去哪群立刻都知道，不用你在每个场景里重新交代一遍。日记即记忆：自然语言的日记和结构化的画像是同一份数据的两个视图，谁都在读同一本账
- **一件事，几个 agent 一起商量着办。** 吃什么群里的两个 agent 不是各发一条广告，而是同一次生成里就商量好怎么接话、怎么抬杠、谁来收口——这是协作，不是各喊各的
- **工具退到后台，你不用挨个打开。** 点外卖、订票、导航变成 agent 商量好之后顺手调用的执行层，就像这版里外卖十级选手自己不接单，只帮你在几个平台里挑一个最合适的
- **拼的不再是谁好用，而是谁更懂你、谁更愿意把这份懂分享出去。** 一个把你的偏好焐在自己肚子里、从不跟别的 agent 通气的，会先被淘汰

体验上最实在的一句话：以前你去找工具，还要自己当中间人到处传话；以后是一群早就商量好的朋友，一起来找你。但主动找你要有分寸——这版专门做了打扰治理（配额、免打扰时段、单个朋友太烦就自动降频），一群人一起找上门，更得知道什么时候该闭嘴。
